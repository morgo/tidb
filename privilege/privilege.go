...
type Manager interface {
	...
	// RequestSEMVerification is similar to RequestDynamicVerification except enforcement
	// is only present when security enhanced mode (SEM) is enabled.
	RequestSEMVerification(activeRoles []*auth.RoleIdentity, privName string, grantable bool) bool
